...
<head>
    <!-- Basic Page Info -->
    <meta charset="utf-8">
    <title>AshMarkets Register </title>

    <!-- Site favicon -->
    <link rel="apple-touch-icon" sizes="180x180" href="https://ashmarkets.com//images/logo.jpeg">
    <link rel="icon"  sizes="32x32" href="https://ashmarkets.com//images/logo.jpeg">
    <link rel="icon"  sizes="16x16" href="https://ashmarkets.com//images/logo.jpeg">
            ...
            <div class="col-md-6 col-lg-5">
                <div class="login-box bg-white box-shadow border-radius-10">
                    <div class="login-title">
                        <h2 class="text-center text-primary">Register To Ashmarkets</h2>
                    </div>
