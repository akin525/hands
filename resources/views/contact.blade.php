    ...
    <section class="gap">
        <div class="container">
            <div class="heading">
                ...
                <h2>Get intouch with Ashmarkets</h2>
            </div>
            <div class="row">
                <div class="col-lg-4 col-md-6">
                    <div class="content-us">
                        ...
                        <a href="mallto:info@ashmarkets.com">info@ashmarkets.com</a>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6">
                    <div class="content-us">
                        ...
                        <span>Email Address.</span>
                        <a href="callto:08169532894">08169532894</a>
...
{{--                        <p>Place your trust in We Love Pets, an award-winning dog walking and pet care</p>--}}
                        <form>
                            <input type="text" name="Enter" placeholder="Enter email address ">
                ...
                <div class="col-lg-6">
                    <div class="looking position-relative contact">
                        <form class="looking-form">
                            <h3>Submit Your Complain tous</h3>
                            <div class="row">
                                <div class="col-lg-6">
