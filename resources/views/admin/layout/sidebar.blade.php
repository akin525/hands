    ...
    <div class="menu-block customscroll">
        <div class="sidebar-menu">
            <ul id="accordion-menu">
                ...
                <li>
                    <a href="{{route('admin/banner')}}" class="dropdown-toggle no-arrow">
                        <span class="micon dw dw-cloud"></span><span class="mtext">Upload Banner</span>
                    </a>
                </li>
                ...
                <li>
                    <a href="{{route('admin/createuser')}}" class="dropdown-toggle no-arrow">
                        <span class="micon dw dw-user"></span><span class="mtext">Create User</span>
                    </a>
                </li>
                <li>
                    <a href="{{route('admin/alluser')}}" class="dropdown-toggle no-arrow">
                        <span class="micon dw dw-user-3"></span><span class="mtext">AllUser</span>
                    </a>
                </li>
