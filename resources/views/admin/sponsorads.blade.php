...
@section('content')
    <div class="min-height-200px">
                ...
                <div class="col-md-6 col-sm-12">
                    ...
                    <nav aria-label="breadcrumb" role="navigation">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Sponsor Advertisement</li>
                        </ol>
                    </nav>
                </div>
            </div>
        ...
        <div class="pd-20 card-box mb-30">
            <div class="clearfix">
                <div class="pull-left">
                    <h4 class="text-blue h4">Kindly Fill All Necessary Space For Your Sponsor Advert</h4>
                </div>
            </div>
            ...
            <form method="post" action="{{route('admin/sponsorad')}}" enctype="multipart/form-data">
                @csrf
