                ...
                <div class="col-xxl-3  col-xl-3 col-lg-4 col-md-5">
                    <div class="cateSidebar">
                        ...
                        <ul class="listing listScroll">
                            <li class="listItem"><a href="ad_lists_category.html" class="items">
                                    <img src="assets/img/icon/caticon1.svg" class="icon" alt="images"> <span>Electronics <span class="itemNumber">(1,200)</span></span>
                                </a></li>
                            <li class="listItem"><a href="ad_lists_category.html" class="items">
                                    <img src="assets/img/icon/caticon2.svg" class="icon" alt="images"> <span> Mobile <span class="itemNumber">(1,299)</span></span>
                                </a></li>
                            <li class="listItem"><a href="ad_lists_category.html" class="items">
                                    <img src="assets/img/icon/caticon3.svg" class="icon" alt="images"> <span> Vehicles <span class="itemNumber">(1,200)</span></span>
                                </a></li>
                            <li class="listItem"><a href="ad_lists_category.html" class="items">
                                    <img src="assets/img/icon/caticon4.svg" class="icon" alt="images"> <span> Appliances <span class="itemNumber">(1,203)</span></span>
                                </a></li>
                            <li class="listItem"><a href="ad_lists_category.html" class="items">
                                    <img src="assets/img/icon/caticon5.svg" class="icon" alt="images"> <span> Fashions <span class="itemNumber">(1,110)</span></span>
                                </a></li>
                            <li class="listItem"><a href="ad_lists_category.html" class="items">
                                    <img src="assets/img/icon/caticon6.svg" class="icon" alt="images"> <span> Properties <span class="itemNumber">(1,200)</span></span>
                                </a></li>
                            <li class="listItem"><a href="ad_lists_category.html" class="items">
                                    <img src="assets/img/icon/caticon7.svg" class="icon" alt="images"> <span> Pets <span class="itemNumber">(1,012)</span></span>
                                </a></li>
                            <li class="listItem"><a href="ad_lists_category.html" class="items">
                                    <img src="assets/img/icon/caticon8.svg" class="icon" alt="images"> <span> Educations <span class="itemNumber">(1,301)</span></span>
                                </a></li>
                            <li class="listItem"><a href="ad_lists_category.html" class="items">
                                    <img src="assets/img/icon/caticon9.svg" class="icon" alt="images"> <span> Businesses <span class="itemNumber">(902)</span></span>
                                </a></li>
                            <li class="listItem"><a href="ad_lists_category.html" class="items">
                                    <img src="assets/img/icon/caticon10.svg" class="icon" alt="images"> <span> Sports <span class="itemNumber">(507)</span></span>
                                </a></li>
                        </ul>
                    ...
                    <div class="gridView customTab-content customTab-content-1 active">
                        <div class="row ">
                            <div class="col-xl-4  col-lg-6  col-md-12 col-sm-6">
                                <div class="singleFeature mb-24">
                                    <div class="featureImg">
                                        <a href="add_details.html"><img src="assets/img/gallery/catitems8.jpg" alt="images"></a>
                                    </div>
                            ...
                            <div class="col-xl-4  col-lg-6  col-md-12 col-sm-6">
                                <div class="singleFeature mb-24">
                                    <div class="featureImg">
                                        <a href="add_details.html"> <img src="assets/img/gallery/catitems2.jpg" alt="images"></a>
                                    </div>
                                    <div class="featureCaption">
                            ...
                            <div class="col-xl-4  col-lg-6  col-md-12 col-sm-6">
                                <div class="singleFeature mb-24">
                                    <div class="featureImg">
                                        <a href="add_details.html"> <img src="assets/img/gallery/catitems3.jpg" alt="images"></a>
                                    </div>
                                    <div class="featureCaption">
                            ...
                            <div class="col-xl-4  col-lg-6  col-md-12 col-sm-6">
                                <div class="singleFeature mb-24">
                                    <div class="featureImg">
                                        <a href="add_details.html"><img src="assets/img/gallery/catitems4.jpg" alt="images"></a>
                                    </div>
                                    <div class="featureCaption">
                            ...
                            <div class="col-xl-4  col-lg-6  col-md-12 col-sm-6">
                                <div class="singleFeature mb-24">
                                    <div class="featureImg">
                                        <a href="add_details.html"><img src="assets/img/gallery/catitems5.jpg" alt="images"></a>
                                    </div>
                                    <div class="featureCaption">
                            ...
                            <div class="col-xl-4  col-lg-6  col-md-12 col-sm-6">
                                <div class="singleFeature mb-24">
                                    <div class="featureImg">
                                        <a href="add_details.html"> <img src="assets/img/gallery/catitems6.jpg" alt="images"></a>
                                    </div>
                                    <div class="featureCaption">
                                        <h4><a href="add_details.html" class="featureTittle">Apple smartwatch 6</a></h4>
                                        <p class="featureCap">Los Angels, CA · <strong class="subCap">12hrs ago</strong></p>
                            ...
                            <div class="col-xl-4 col-lg-6  col-md-12  col-sm-6">
                                <div class="singleFeature mb-24">
                                    <div class="featureImg">
                                        <a href="add_details.html"> <img src="assets/img/gallery/catitems7.jpg" alt="images"></a>
                                    </div>
                                    <div class="featureCaption">
                                        <h4><a href="add_details.html" class="featureTittle">Apple smartwatch 6</a></h4>
                                        <p class="featureCap">Los Angels, CA · <strong class="subCap">12hrs ago</strong></p>
                            ...
                            <div class="col-xl-4 col-lg-6  col-md-12  col-sm-6">
                                <div class="singleFeature mb-24">
                                    <div class="featureImg">
                                        <a href="add_details.html"> <img src="assets/img/gallery/catitems9.jpg" alt="images"></a>
                                    </div>
                                    <div class="featureCaption">
                                        <h4><a href="add_details.html" class="featureTittle">Apple smartwatch 6</a></h4>
                                        <p class="featureCap">Los Angels, CA · <strong class="subCap">12hrs ago</strong></p>
