<head>
    ...
    <meta name="description" content="Promoting Good And Services on ashmarkets.com.ng" />
    <title>View Items</title>
    <link rel="icon"  sizes="20x20" href="https://ashmarkets.com.ng//images/ash.jpeg">
        ...
        <div class="NavWrapper">
            ...
            <div class="collapse navbar-collapse" id="bizcoxx_main_menu">
                <ul class="navbar-nav">
                    ...
                    @endif
                    <li><a href="{{url('promotion')}}">All Items</a></li>
