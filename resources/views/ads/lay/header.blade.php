            ...
            <div class="sibeBar-Wrapper">
                ...
                <div class="sideBar">
                    ...
                    <a href="#" class="sidebarBtn">
                        <i class="las la-bars iconLeft"></i> <span class="allCat">All Categories</span><i class="las la-angle-down iconRight"></i>
                    </a>

                    <div class="showSidebar">
                        <ul>
                            <li class="singleList">
                                <a href="#" class="tittle"><i class="las la-phone-volume icon"></i> Phone and Electronics</a>
                            </li>
                            <li class="singleList">
                                <a href="#" class="tittle"><i class="las la-phone-volume icon"></i> Phone and Electronics</a>
                            </li>
                            <li class="singleList menu-item-has-children current-menu-item">
                                <a href="#" class="tittle"> <i class="las la-headphones icon"></i> Top 10 Offers </a>
                                <div class="megamenuWrapper">
                                    <div class="singleMegamenu">
                                        <div class="megamenu-product">
                                            <div class="product-img">
                                                <a href="#"> <img src="assets/img/gallery/catitems1.jpg" alt="images"> </a>
                                            </div>
                                            <div class="megamenu-contents">
                                                <h4> <a href="{{url('listads')}}" class="megamenu-title"> items Tittle </a> </h4>
                                                <div class="price">
                                    ...
                                    <div class="singleMegamenu">
                                        <div class="megamenu-product">
                                            <div class="product-img">
                                                <a href="{{url('listads')}}"> <img src="assets/img/gallery/catitems2.jpg" alt="images"> </a>
                                            </div>
                                            <div class="megamenu-contents">
                                                <h4> <a href="{{url('listads')}}" class="megamenu-title"> items Tittle </a> </h4>
                                                <div class="price">
                                    ...
                                    <div class="singleMegamenu">
                                        <div class="megamenu-product">
                                            <div class="product-img">
                                                <a href="{{url('listads')}}"> <img src="assets/img/gallery/catitems3.jpg" alt="images"> </a>
                                            </div>
                                            <div class="megamenu-contents">
                                                <h4> <a href="{{url('listads')}}" class="megamenu-title"> items Tittle </a> </h4>
                                                <div class="price">
                                    ...
                                    <div class="singleMegamenu">
                                        <div class="megamenu-product">
                                            <div class="product-img">
                                                <a href="{{url('listads')}}"> <img src="assets/img/gallery/catitems4.jpg" alt="images"> </a>
                                            </div>
                                            <div class="megamenu-contents">
                                                <h4> <a href="{{url('listads')}}" class="megamenu-title"> items Tittle </a> </h4>
                                                <div class="price">
                                    ...
                                    <div class="singleMegamenu">
                                        <div class="megamenu-product">
                                            <div class="product-img">
                                                <a href="{{url('listads')}}"> <img src="assets/img/gallery/catitems5.jpg" alt="images"> </a>
                                            </div>
                                            <div class="megamenu-contents">
                                                <h4> <a href="{{url('listads')}}" class="megamenu-title"> items Tittle </a> </h4>
                                                <div class="price">
                                    ...
                                    <div class="singleMegamenu">
                                        <div class="megamenu-product">
                                            <div class="product-img">
                                                <a href="{{url('listads')}}"> <img src="assets/img/gallery/catitems6.jpg" alt="images"> </a>
                                            </div>
                                            <div class="megamenu-contents">
                                                <h4> <a href="{{url('listads')}}" class="megamenu-title"> items Tittle </a> </h4>
                                                <div class="price">
                                    ...
                                    <div class="singleMegamenu">
                                        <div class="megamenu-product">
                                            <div class="product-img">
                                                <a href="{{url('listads')}}"> <img src="assets/img/gallery/catitems7.jpg" alt="images"> </a>
                                            </div>
                                            <div class="megamenu-contents">
                                                <h4> <a href="{{url('listads')}}" class="megamenu-title"> items Tittle </a> </h4>
                                                <div class="price">
                                    ...
                                    <div class="singleMegamenu">
                                        <div class="megamenu-product">
                                            <div class="product-img">
                                                <a href="{{url('listads')}}"> <img src="assets/img/gallery/phoneCat1.jpg" alt="images"> </a>
                                            </div>
                                            <div class="megamenu-contents">
                                                <h4> <a href="{{url('listads')}}" class="megamenu-title"> items Tittle </a> </h4>
                                                <div class="price">
                                    ...
                                    <div class="singleMegamenu">
                                        <div class="megamenu-product">
                                            <div class="product-img">
                                                <a href="{{url('listads')}}"> <img src="assets/img/gallery/catitems9.jpg" alt="images"> </a>
                                            </div>
                                            <div class="megamenu-contents">
                                                <h4> <a href="{{url('listads')}}" class="megamenu-title"> items Tittle </a> </h4>
                                                <div class="price">
                            ...
                            <li class="singleList">
                                <a href="#" class="tittle"><i class="las la-mouse icon"></i> Mouse Electronics </a>
                            </li>
                            <li class="singleList">
                                <a href="#" class="tittle"><i class="las la-laptop icon"></i>Jewelry Watches </a>
                            </li>
                        </ul>
                    </div>
                </div>
