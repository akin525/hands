                ...
                <div class="col-xxl-6 col-xl-7 col-lg-6">
                    <div class="about-caption about-caption2 mb-15  text-center">
                        ...
                        <div class="btn-wrapper">
                            <a href="#" class="cmn-btn2 mr-15 mb-10 wow fadeInLeft" data-wow-delay="0.3s">Post your ad</a>
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-3">
                    ...
                    <div class="singleFeature mb-24">
                        <div class="featureImg">
                            <a href="#"><img src="assets/img/gallery/featured8.jpg" alt="images"></a>
                        </div>
                        <div class="featureCaption">
                            <h4><a href="#" class="featureTittle">Apple smartwatch 6</a></h4>
                ...
                <div class="col-lg-3">
                    ...
                    <div class="singleFeature mb-24">
                        <div class="featureImg">
                            <a href="#"> <img src="assets/img/gallery/featured2.jpg" alt="images"></a>
                        </div>
                        <div class="featureCaption">
                            <h4><a href="#" class="featureTittle">Samsung M32</a></h4>
                            <p class="featureCap">Los Angels, CA · <strong class="subCap">12hrs ago</strong></p>
                            <span class="featurePricing">₦139.40</span>
                            <div class="btn-wrapper">
                                <span class="pro-btn1">NEW</span>
                ...
                <div class="col-lg-3">
                    ...
                    <div class="singleFeature mb-24">
                        <div class="featureImg">
                            <a href="#"> <img src="assets/img/gallery/featured3.jpg" alt="images"></a>
                        </div>
                        <div class="featureCaption">
                            <h4><a href="#" class="featureTittle">Persian cat</a></h4>
                            <p class="featureCap">Los Angels, CA · <strong class="subCap">12hrs ago</strong></p>
                            <span class="featurePricing">₦139.40</span>
                            <div class="btn-wrapper">
                                <span class="pro-btn1">NEW</span>
                ...
                <div class="col-lg-3">
                    ...
                    <div class="singleFeature mb-24">
                        <div class="featureImg">
                            <a href="#"><img src="assets/img/gallery/featured4.jpg" alt="images"></a>
                        </div>
                        <div class="featureCaption">
                            <h4><a href="#" class="featureTittle">Beats headphone</a></h4>
                            <p class="featureCap">Los Angels, CA · <strong class="subCap">12hrs ago</strong></p>
                            <span class="featurePricing">₦139.40</span>
                            <div class="btn-wrapper">
                                <span class="pro-btn1">NEW</span>
                ...
                <div class="col-lg-3">
                    ...
                    <div class="singleFeature mb-24">
                        <div class="featureImg">
                            <a href="#"><img src="assets/img/gallery/featured5.jpg" alt="images"></a>
                        </div>
                        <div class="featureCaption">
                            <h4><a href="#" class="featureTittle">4 Bed 2 storey house</a></h4>
                            <p class="featureCap">Los Angels, CA · <strong class="subCap">12hrs ago</strong></p>
                            <span class="featurePricing">₦1,000,000.40</span>
                            <div class="btn-wrapper">
                                <span class="pro-btn1">NEW</span>
                                <span class="pro-btn2">PROMTED</span>
                            </div>
                ...
                <div class="col-lg-3">
                    ...
                    <div class="singleFeature mb-24">
                        <div class="featureImg">
                            <a href="#"> <img src="assets/img/gallery/featured6.jpg" alt="images"></a>
                        </div>
                        <div class="featureCaption">
                            <h4><a href="#" class="featureTittle">Apple smartwatch 6</a></h4>
                            <p class="featureCap">Los Angels, CA · <strong class="subCap">12hrs ago</strong></p>
                            <span class="featurePricing">₦120,000.40</span>
                            <div class="btn-wrapper">
                                <span class="pro-btn1">NEW</span>
                                <span class="pro-btn2">PROMTED</span>
                            </div>
                ...
                <div class="col-lg-3">
                    ...
                    <div class="singleFeature mb-24">
                        <div class="featureImg">
                            <a href="#"> <img src="assets/img/gallery/featured7.jpg" alt="images"></a>
                        </div>
                        <div class="featureCaption">
                            <h4><a href="#" class="featureTittle">Apple smartwatch 6</a></h4>
                            <p class="featureCap">Los Angels, CA · <strong class="subCap">12hrs ago</strong></p>
                            <span class="featurePricing">₦139,000.40</span>
                            <div class="btn-wrapper">
                                <span class="pro-btn1">NEW</span>
                                <span class="pro-btn2">PROMTED</span>
                            </div>
